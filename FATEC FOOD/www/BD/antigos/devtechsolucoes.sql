...
-- Tempo de geração: 19/06/2023 às 22:54
...
(2, 'anderson silva', 'M', '1978-10-27', 'anders', '$2y$10$67pVWoWFTLMBxLaPFtpldOh9kkvnrlHJ8Pttjz9b8olF/ME1Bm9tq', '18997752582', 'anderrevisor@hotmail.com', '11111111100'),
(9, 'anderson silva', 'M', '2023-06-18', 'msilva', '$2y$10$d8EyVNXAJO0BYKp8EfK9kOudvLkqxX.LO43W0JwRSyTpqmM8BrmCS', '18997752582', 'msilva@hotmail.com', '11111111100'),
(10, 'Manoel', 'M', '2023-06-08', 'Mal', '$2y$10$iEntac/u7z/GY4wPGhwrWuGOyn7HpK8GDvS/mr40FVh5XYT7ZFw5S', '18997752582', 'andermsilva@gmail.com', '11111111100'),
(11, 'suzana', 'F', '0997-03-23', 'sousa', '$2y$10$R.xY2JK6ONlk8lK9LOhrKOkmXs0nBwHqtdqI8LyunMjls8.DDd0ty', '18998018127', 'suzhy48@gamil.com', '11111111100'),
(12, 'suzana', 'F', '1997-03-12', 'sousa', '$2y$10$6HH17zPNE7A9KkpRlnEKpe9v.Nsw/JBg0ckzGU8guqwCfJlfoP4tS', '11987655544', 'suzhy48@gamil.com', '11111111100'),
(13, 'brendon', 'M', '1995-07-19', 'Feitosa', '$2y$10$7d38eZMpJkRZBL37zAvYKe3VYtaHYYT7..9S3ccBTd32W7UFe5xNi', '18981077130', 'brendongstv@gmail.com', '11111111100');
...
CREATE TABLE `historia` (
  ...
  `fundacao` mediumtext DEFAULT NULL,
...
(110, 3, 1, '2023-06-19 22:21:38', '53.65', 34, 2),
...
(6, 1, 'tutu de feijão', 'Feijão com bacon, farinha de mandioca torrada couve refogada, ovo frito e torresmo', '22.00', 1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcVFkx_oIflzIwHXpOa4hf6WAclQuelPe6bA&usqp=CAU', '0.25', '5.00'),
(7, 21, 'Frita', 'batata frita em formato de palito', '5.00', 1, 'https://segredosdacomida.com.br/wp-content/uploads/2022/11/1-kg-de-batata-frita-serve-quantas-pessoas-1200x857.jpg', '0.10', '3.00'),
...
(10, 7, 'Baião de dois', 'Arroz feijão de corda, torresmo, couve,bisteca suina e linguiça', '25.00', 1, 'https://receitinhas.com.br/wp-content/uploads/2022/11/baiao-de-dois-vegano-Receitas-Club-Oficial.webp', '0.30', '2.00'),
...
(2, 'Suzana', 'suzanacabecadebanana@hotmail.com', '$2y$10$7a72qqsolsdU/.i105rxS.aWVe0RLYR3OBbeSqd9Fg6gd1LPIn10m', 'adm'),
(3, 'Brendon', 'brendonfeitosa@hotmail.com', '$2y$10$cRfiVlZ8rmM1C1TdbAMv1.gDvEIN.OieUhvOnyxOvx.FKXH3Xy7BS', 'adm'),
(5, 'balcão', 'balcao@teste.com', '$2y$10$DmRq84RrJyDHqtgWT541aem9C.gpRMOGOHnetzy8ynPbHsio5JSSe', 'adm'),
(7, 'balcão', 'balcao@teste.com.br', '$2y$10$r0czC5pEjsrxyJ30kESD/uE.dwKVCrO1NBA0GwimqFNMFoRdBMALG', 'adm');
...
--
ALTER TABLE `endereco`
  MODIFY `end_cod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
--
...
--
ALTER TABLE `pagamento`
  MODIFY `pag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT de tabela `pedido`
--
ALTER TABLE `pedido`
  MODIFY `ped_num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
--
